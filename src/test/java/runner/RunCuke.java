...
public class RunCuke extends AbstractTestNGCucumberTests{
    ...
    public static void setup() {
        ...
        String fileName = System.getProperty("user.dir")+ "\\target\\Extent_Reports\\report" + strDate+".html";
        ...
        ExtentCucumberFormatter.addSystemInfo("Browser version", "67.0.3396.99");
        ExtentCucumberFormatter.addSystemInfo("Selenium version", "v3.13.0");
